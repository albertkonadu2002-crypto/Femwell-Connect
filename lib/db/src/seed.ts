...
async function seed() {
  ...
  const products = await db.insert(productsTable).values([
    {
      ...
      description: "Our essential care kit for comfortable, confident period management.",
      price: 49.99,
      category: "Essential",
      imageUrl: "/images/products/product-standard.jpg",
      featured: true,
      inStock: true,
      contents: ["12x Sanitary pads (day)", "6x Panty liners", "1x Hand sanitizer 50ml", "1x Educational leaflet"],
    },
    {
      name: "Premium Femwell Connect Kit",
      description: "A comprehensive care package for complete comfort and wellness support.",
      price: 89.99,
      category: "Premium",
      imageUrl: "/images/products/product-premium.jpg",
      featured: true,
      inStock: true,
      contents: ["24x Sanitary pads", "12x Panty liners", "2x Pregnancy test strips", "1x Feminine wash 200ml", "1x Pain relief", "1x Wellness booklet"],
    },
    {
      name: "Femwell Connect Teen Kit",
      description: "Specially designed for younger women starting their health journey.",
      price: 35.99,
      category: "Essential",
      imageUrl: "/images/products/product-teen.jpg",
      featured: false,
      inStock: true,
      contents: ["8x Sanitary pads (light)", "6x Panty liners", "1x Mini hand sanitizer", "1x Teen health guide"],
    },
    {
      name: "Femwell Connect Wellness Bundle",
      description: "A complete wellness package combining hygiene essentials with reproductive health tools.",
      price: 120,
      category: "Wellness",
      imageUrl: "/images/products/product-wellness.jpg",
      featured: true,
      inStock: true,
      contents: ["24x Sanitary pads", "12x Panty liners", "3x Pregnancy test strips", "1x Ovulation kit", "1x Feminine wash", "1x Pain relief", "1x Wellness handbook"],
    },
  ]).returning();
  ...
  await db.insert(reviewsTable).values([
    ...
    },
    {
      ...
      rating: 5,
      comment: "Bought this for my sister at KNUST. She absolutely loved it. The ovulation kit is a great addition. Fast delivery too.",
    },
  ]);
